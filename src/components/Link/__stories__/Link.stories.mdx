...
import "./Link.stories.scss"; import {Flex} from "components";
...
## Overview
Links are accessible text elements used primarily for navigation.
...
<UsageGuidelines guidelines={[
    "Use links only as part of the text or sentence.",
...
<Canvas>
  <Story name="Reference link">
    <Flex wrap>Lorem Ipsum has been the industry's <Link text="standard" href="https://www.monday.com" className="" /> dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </Flex>
  </Story>
</Canvas>
