...
import MoveArrowDown from "../../Icon/Icons/components/MoveArrowDown"; import {
    StoryDescription
...
<Canvas>
  <Story name="Sizes">
      <Flex align={Flex.align.START} justify={Flex.justify.START}>
          <StoryDescription description="XXS" vertical headerJustify={Flex.justify.CENTER}>
          ...
          <StoryDescription description="XS" vertical headerJustify={Flex.justify.CENTER}>
          ...
          <StoryDescription description="Small" vertical headerJustify={Flex.justify.CENTER}>
          ...
          <StoryDescription description="Medium" vertical headerJustify={Flex.justify.CENTER}>
          ...
          <StoryDescription description="Large" vertical headerJustify={Flex.justify.CENTER}>
