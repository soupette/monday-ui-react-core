...
export const metaSettings = createStoryMetaSettings({
    ...
    enumPropNamesArray: ["type", "textPlacement"],
    iconPropNamesArray: ["fulfilledStepIcon"],
...
## Overview
Navigation component that helps users visualize and interact with a multi-step process.
...
## Variants
### Placements
we have two Placement variants, use the one most suites your design.
<Canvas>
